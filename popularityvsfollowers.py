...
df = pd.read_csv("C:/Users/Ik/Desktop/C++/Assignment 1/artist_data.csv")
...
plt.figure()
plt.scatter(df['followers_log'], df['artist_popularity'], alpha=0.5, label='Data Points')
...
print(overperformers[["artist_name", "followers", "artist_popularity", "residual"]])
print("\nTop 10 legacy artists:")
print(legacy_artists[["artist_name", "followers", "artist_popularity", "residual"]])
